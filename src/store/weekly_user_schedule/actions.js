...
export const add = async ({ commit }, payload) => {
    ...
    try {
        res = await axios({
        method: "post",
        url: `${getEnv('API_BASE_URL')}/users/sched/create`,
        data: payload,
        headers: headers,
        })
    } catch (e) {
...
export const get = async ({ commit }, payload) => {
    ...
    try {
        res = await axios({
        method: "get",
        url: `${getEnv('API_BASE_URL')}/users/sched/getall/`,
        params: payload,
        headers: headers,
        })
    } catch (e) {
...
export const update = async ({ commit }, payload) => {
    ...
    try {
        res = await axios({
        method: "post",
        url: `${getEnv('API_BASE_URL')}/users/sched/update/?id=${payload.id}`,
        data: payload.data,
        headers: headers,
        })
    } catch (e) {
...
export const getSpecific = async ({ commit }, payload) => {
    ...
    try {
        res = await axios({
        method: "get",
        url: `${getEnv('API_BASE_URL')}/users/sched/getone/`,
        params: payload,
        headers: headers,
        })
    } catch (e) {
