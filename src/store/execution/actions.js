...
export const add = async ({ commit }, payload) => {
    ...
    try {
        res = await axios({
        method: "post",
        url: `${getEnv('API_BASE_URL')}/execution-type/create`,
        data: payload,
        headers: headers,
        })
    } catch (e) {
...
export const get = async ({ commit }, payload) => {
    ...
    try {
        res = await axios({
        method: "get",
        url: `${getEnv('API_BASE_URL')}/execution-type/getall/`,
        params: payload,
        headers: headers,
        })
    } catch (e) {
...
export const update = async ({ commit }, payload) => {
    ...
    try {
        res = await axios({
        method: "post",
        url: `${getEnv('API_BASE_URL')}/execution-type/update/`,
        data: payload.data,
        params: payload,
        headers: headers,
        })
...
export const getSpecific = async ({ commit }, payload) => {
    ...
    try {
        res = await axios({
        method: "get",
        url: `${getEnv('API_BASE_URL')}/execution-type/getone/`,
        params: payload,
        headers: headers,
        })
    } catch (e) {
