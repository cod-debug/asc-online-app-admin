...
<script>
// NOTE: lalabas lang yung SEND DECISION OR STAMPED MATERIAL na button kapag di null yung release status at decision status
  import { stat } from "fs";
  ...
  export default {
    ...
    methods: {
      ...
      update(row) {
        ...
        //   this.lockModal = true;
        // }
        this.$router.push({ name: "s2-individual-application-update", params: { id: row.id } });
      },
