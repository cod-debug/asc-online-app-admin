    ...
    <div class="q-pa-md q-gutter-sm">
        ...
        <q-card class=""  style="width: 500px; max-width: 80vw;">
            <q-card-section class="bg-red-14 text-white">
                <div class="text-h6"><q-icon name="fa-solid fa-exclamation-triangle" /> Forgot Password</div>
            </q-card-section>

            <q-card-section class="q-pt-none">
                <q-form>
                    <q-input label="Email Address * " outlined v-model="email_address" class="q-my-md" multiple option-label="reason" option-value="label" />
                </q-form>
                <div class="row">
